...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					wait: 'Espera mi tio, estoy trabajando en eso e,.,e/',
					success: 'Pronto',
					levelon: '*leveling* *activado*',
					leveloff: '*leveling* *desactivado*',
					levelnoton: ' *leveling no ativado*',
					levelnol: '*ERROR* °-°',
					error: {
				stick: 'No se pudo convertir a foto/video en sticker sorry prro, la vida es triste',
				Iv: 'Link invalido'
				},
				only: {
					group: 'Este comando solo puede ser usado en grupos tio',
					premium: `Hey {pushname2} Soló usuarios PREMIUMS pueden usar este comando*`,
					mod: 'ESTE PEDIDO ÉS ESPECÍFICO PARA UN MODERADOR DE ⚡HH BOT⚡*',
					benned: 'Usted fue baneado, contacte con el dueño para ser desbaneado',
					ownerG: 'Solo Hatori puede usar este comando papu',
					ownerB: 'Solo Hatori puede usar este comando papu',
					userB: `──「 LISTA 」──\nHola ${pushname} !\nUsted no esta registrado como amigo de mi dueño,entonces pulse para que el te añada como amigo\n\n──「 ⚡BOT HH⚡ 」──`,
					admin: 'Este comando solo puede ser usado por administradores del grupo!',
					Badmin: 'Este comando solo puede ser usado cuando ⚡HH BOT⚡ se vuelve admin del grupo!',
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["51928564603@s.whatsapp.net","51928564603@s.whatsapp.net","51928564603@s.whatsapp.net"] // Recoloque o seu numero
			const mod = [ownerNumber,"51928564603@s.whatsapp.net","51928564603@s.whatsapp.net","51928564603@s.whatsapp.net"]// Moderador do bot
			const adminbotnumber = ["51928564603@s.whatsapp.net","51928564603@s.whatsapp.net","51928564603@s.whatsapp.net"]// admin bot numero
			const frendsowner = ["51928564603@s.whatsapp.net","51928564603@s.whatsapp.net","51928564603@s.whatsapp.net"]// amigo do criador 
			const premium = ["51928564603@s.whatsapp.net","593960159468@s.whatsapp.net","5491130465477@s.whatsapp.net","51928564603@s.whatsapp.net","558981204807@s.whatsapp.net","558981213553@s.whatsapp.net","554999498331@s.whatsapp.net","558981309535@s.whatsapp.net","558981309535@s.whatsapp.net"]
...
axios.get(`http://geradorapp.com/api/v1/cpf/generate?token=40849779ec68f8351995def08ff1e2fa`).then((res) => {
	conn.sendMessage(id, 'ESTOY PROCESANDO', MessageType.text)
...
axios.get(`https://viacep.com.br/ws/${aris}/json/`).then((res) => {
	conn.sendMessage(id, '𝙿𝙴𝚁𝙰', MessageType.text)
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		if (isGroupAdmins) return reply('calla, no diga esas cosas, esta mal, cuidate que el admin te banee')
		client.updatePresence(from, Presence.composing)
		if (messagesC.includes("#izinadmin")) return reply("#izinadmin diterima")
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`tchau racista ${sender.split("@")[0]} usted sera expulsado dentro de 5 segundos`)
		setTimeout( () => {
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("5 segundo xd chau joto 🤙")
		}, 0)
	}
	
	        if (messagesC.includes(" eres negro")){
		if (!isGroup) return
		if (!isAntiRacismo) return
		if (isGroupAdmins) return reply('calla, no diga esas cosas, esta mal, cuidate que el admin te banee')
		client.updatePresence(from, Presence.composing)
		if (messagesC.includes("#izinadmin")) return reply("#izinadmin diterima")
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`tchau racista ${sender.split("@")[0]} `)
		setTimeout( () => {
			client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		}, 5000)
		setTimeout( () => {
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("*meliodas")){
			...
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/gay.jpg');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
	...
	if (messagesC.includes("xandao")){
			...
			switch(command) {
				...
				mentions(teks, membr, true)
					break
				case 'otakus':
					if (!isGroup) return reply(`Comando solo utilizado en grupos`)
					membr = []
					...
					teks = `${pushname} esos son los otakus perdidos del grupo\n@${otakus1.jid.split('@')[0]}\n@${otakus2.jid.split('@')[0]}\n@${otakus3.jid.split('@')[0]}\n@${otakus4.jid.split('@')[0]}\n@${otakus5.jid.split('@')[0]}\n@${otakus6.jid.split('@')[0]}\n@${otakus7.jid.split('@')[0]}\n@${otakus8.jid.split('@')[0]}\n@${otakus9.jid.split('@')[0]}\n@${otakus10.jid.split('@')[0]}\n\nSEM PRESSÃO AQUI É ⚡ Xandão ⚡`
				...
				if (vit == "victoria") {
				var tes = "Victória del jugador"
				}
				if (vit == "derrota" ) {
				var tes = "La victoria es de ⚡HH BOT⚡"
				}
				if (vit == "empate" ) {
				var tes = "El juego termino en empate"
				}
				reply(`HH BOT⚡ jugó: ${pptb}\nO jugador jugó: ${args}\n\n${tes}`)
				if (tes == "Victoria del jugador") {
				reply(pph)
				}
					break
				case 'github':
				reply(`https://github.com/yulking95/Bot`)
				setTimeout( () => {
				client.sendMessage(from, Presence.composing)
				reply(`${pushname} ese es el link de git de ⚡HH BOT⚡`)
				}, 1000)
					break
				case 'install':
			...
			setTimeout( () => {
			client.sendMessage(from, Presence.composing)
			reply("Usted necesita tener termux instaldo y 2 celulares, cuando pide Y/N escriba y para aceptar, si pide Y/N/M/S o algo de ese tipo escriba Y para aceptar, necesita hacer eso hasta que le aparesca el codigo QR")
			}, 1000)
			setTimeout( () => {
				client.updatePresence(from, Presence.composing)
			...
			setTimeout( () => {
				client.updatePresence(from, Presence.composing)
				reply("pkg install git && pkg install ffmpeg && pkg install wget && pkg install nodejs && git clone https://github.com/yulking95/Bot")
			}, 3000)
			setTimeout( () => {
				client.updatePresence(from, Presence.composing)
				reply("cd Bot")
			...
			setTimeout( () => {
				...
				reply("npm start")
					...
					case 'lista':
					if (!isGroup) return reply(mess.only.group)
					if (!isOwner) return reply('Ud es el proprietário?')
					if (args.length < 1) return reply('donde esta el texto?')
					reply(mess.wait)
					client.sendMessage(from, 'mensaje adicionado a la lista' , text, { quoted: mek })
					...
					if (!isGroup) return reply(mess.only.group)
						...
						teks = `*Hmmm.... yo shipeo a esas 2💘💘*\n\n1= @${teupai11.jid.split('@')[0]}\nes esa\n2= @${teupai21.jid.split('@')[0]}\ncon un porcentaje de: ${shipted}`
						membr.push(teupai11.jid)
						membr.push(teupai21.jid)
						mentions(teks, membr, true)
					break
					case 'gays':
					if (!isGroup) return reply(`ese comando solo puede ser usados en grupos`)
					membr = []
					...
					teks = `${pushname} Esoos son los cornudos del grupo ${groupName}\n@${cornos1.jid.split('@')[0]}\nCon un porcentaje de ${porcentagemc}\n@${cornos2.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagemc}\n@${cornos3.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagemc}\n@${cornos4.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagemc}\n@${cornos5.jid.split('@')[0]}\nCom uma porcentagem de ${porcentagemc}\n\n Sem pressão Neném, ⚡Xandão⚡ ta aqui`
                    ...
                    case 'patas':
                     if (!isGroup) return reply(mess.only.group)
                      ...
                      reply(`*ＤＥＴＥＣＴＯＲ   ＤＥ  P A T A S👩‍⚕️ XD*\n\n*pi pi pi pi*  \n*mmmmm..,m.m.mm.*\n\n@${gostoso11.jid.split('@')[0]} @${gostoso12.jid.split('@')[0]} *alto ahi csm🖐*\n*valor de multa:*\n*FOTO DE SUS PATAS AL PV*`)
                    ...
                    case 'lindos':
                     if (!isGroup) return reply(mess.only.group)
                      ...
                      reply(`*${pushname2} Esos son los mas lindos\n${groupName}\n\n@51928564603\n@${cuzao11.jid.split('@')[0]} \n@${cuzao12.jid.split('@')[0]} \n@${cuzin21.jid.split('@')[0]} \n@${cuzin22.jid.split('@')[0]} \n\n Cortesia de Super Xandão`)
                      membr.push(cu11.jid)
                      membr.push(cu12.jid)
				    ...
				    hai = body.slice(8)
						...
						reply(`Realizado ${hai} Adicionado a los banco de datos`)
						break
                   case 'saylist':
				...
				case 'ssweb':
					...
					if (args.length < 1) return reply('lugar o url tio')
					tekss = body.slice(7)
					reply(mess.wait)
					...
					break
                case 'ytkomen':
					if (args.length < 1) return reply('lugar o texto tio?')
					gh = body.slice(9)
					usnm = gh.split("|")[0];
					cmn = gh.split("|")[1];
				...
				case 'walpaperhd':
                    ...
                    if (!isGroup) return reply(from, 'este comando solo puede se usado dentro del grupo', id)
				...
				case 'ramaljadian':
                   ...
                   case 'gcpf':
                    ...
                    break
				case 'ytmp4':
					if (args.length < 1) return reply('inserta la url tio!')
		...
		case 'iri':
			...
			break
				case 'ytmp3':
			    	if (!isPremium) return reply(mess.only.premium)
                   reply(mess.wait)
					if (args.length < 1) return reply('Codigo url, hum?')
					if(!isUrl(args[0]) && !args[0].includes('youtu')) return reply(mess.error.Iv)
				...
				case 'game':
					...
					setTimeout( () => {
					client.sendMessage(from, '_20 Otro segundo_…', text) // ur cods
					}, 10000) // 1000 = 1s,
					setTimeout( () => {
					client.sendMessage(from, '_30 Otro segundo_…', text) // ur cods
					}, 1000) // 1000 = 1s,
					setTimeout( () => {
				...
				case 'snowrite':
					...
					var gbl7 = gh.split("|")[0];
					var gbl8 = gh.split("|")[1];
					if (args.length < 1) return reply('codigo o texto?, hum')
					reply(mess.wait)
				...
				case 'thunder':
					...
					break
                case 'stiltext':
                      if (args.length < 1) return reply('codigo o texto?')
                      gh = body.slice(11)
                      gl1 = gh.split("|")[0];
                      gl2 = gh.split("|")[1];
		...
		case 'tahta':
                tahta = `${body.slice(7)}`
                  ...
                  break  
                    ...
                    break
          case 'snack':
				if (args.length < 1) return reply('Codigo o url tio?')
               ...
               if (anu.error) return reply(anu.error)
				...
				case 'modoanime':
					...
					if ((args[0]) === 'on') {
						if (isAnime) return reply('O modo anime yá está activo')
						anime.push(from)
						fs.writeFileSync('./database/json/anime.json', JSON.stringify(anime))
						reply(`\`\`\`✓Activado con excito el modo anime del grupo\`\`\` *${groupMetadata.subject}*`)
					} else if ((args[0]) === 'off') {
						anime.splice(from, 1)
						fs.writeFileSync('./database/json/anime.json', JSON.stringify(anime))
						reply(`\`\`\`✓Modo anime desactivado con excito del grupo\`\`\` *${groupMetadata.subject}*`)
					} else {
					...
					if (args.length < 1) return reply('Hmmmm')
					if ((args[0]) === 'on') {
						if (isAntiRacismo) return reply('El modo antiracismo ya esta activado')
						antiracismo.push(from)
						fs.writeFileSync('./database/json/antiracismo.json', JSON.stringify(antiracismo))
						reply(`\`\`\`✓Activado con excito el modo antiracismo en el grupo\`\`\` *${groupMetadata.subject}*`)
					} else if ((args[0]) === 'off') {
						antiracismo.splice(from, 1)
						fs.writeFileSync('./database/json/antiracismo.json', JSON.stringify(antiracismo))
						reply(`\`\`\`✓Modo antiracismo desactivado con sucesso en el grupo\`\`\` *${groupMetadata.subject}*`)
					} else {
						reply('On para activar, Off para desactivar')
					}
					break
				case 'modonsfw':
					...
					if (args.length < 1) return reply('Hmmmm')
					if ((args[0]) === 'on') {
						if (isNsfw) return reply('El modo nsfw ya está ativo')
						nsfw.push(from)
						fs.writeFileSync('./database/json/nsfw.json', JSON.stringify(nsfw))
						reply(`\`\`\`✓Activado con excito o modo nsfw en el grupo\`\`\` *${groupName}*`)
					} else if ((args[0]) === 'off') {
						nsfw.splice(from, 1)
						fs.writeFileSync('./database/json/nsfw.json', JSON.stringify(nsfw))
						reply(`\`\`\`✓Modo nsfw desactivado con excito en el grupo\`\`\` *${groupName}*`)
					} else {
						reply('On para activar, Off para desactivar')
					}
					break
				case 'rtext':
					if (args.length < 1) return reply(mess.blank)
					tels5 = body.slice(7)
					if (tels5.length > 10) return reply('el texto es muy largo, como mucho 10 caracteres')
					reply(mess.wait)
				...
				case 'water':
					...
					break
                 case 'nombregp':
                 if (!isGroup) return reply(`Este comando sólo puede ser usado en grupos`)
		             if (args.length < 1) return reply (`el nombre del grupo es: *${groupName}*`)
		             break
				case 'loli2':
					if (!isAnime) return reply('❌ *Debe activar el modoanime* ❌')
...
//@darkYT					
    ...
    break
				...
				case 'textblue':
					...
					break
					case 'vipmenu':
					if (!isPremium) return reply('usted no es un miembro Premium, entre en contacto con el proprietárioo digite: *#daftarvip* para comprar acesso a Premium!' ,text, { quoted: mek })
				...
				case 'nulis':
				case 'tulis':
					if (args.length < 1) return reply('que dessea escribir??') 
					teks = body.slice(7)
					reply(mess.wait)
				...
				case 'bloquear':
				 ...
				 client.chatRead (from)
					...
					client.sendMessage(from, `Bendiciones, hatori te ha bloqueado ${body.slice(7)}@c.us`, text)
					break
				case 'premiumlist':
					teks = '╭────*「 *PREMIUM USER👑* 」\n'
                  ...
                  case 'qrcode':
					...
					if (!tex) return client.sendMessage(from, 'Digite un texto/url que desea copiar/ código qr', text, {quoted: mek})
               ...
               case 'pornhub':
			   reply(mess.wait)
              	    if (args.length < 1) return reply('Codigo o texto,tio?')
                    teks = body.slice(9)
            ...
            case 'bodoh':
				...
				case 'hunti':
                 ...
                 case 'setdesc':
				     ...
				     client.sendMessage(from, 'Descripcion alterada com excito', text, {quoted: mek})
				     break
			case 'google':
                const googleQuery = body.slice(8)
                if(googleQuery == undefined || googleQuery == ' ') return reply(`*Hasil Pencarian : ${googleQuery}* tidak ditemukan`)
                google({ 'query': googleQuery }).then(results => {
                let vars = `_*Resultado de busqueda : ${googleQuery}*_\n`
		...
		case 'bpfont':
			...
			break 
				...
				case 'del':
				case 'd':  
					if (!isPremium) return reply('Usted no es un usuario premium, contacte con el dueño o digite: *.Daftarvip* para adquirir el acesso Premium!' ,text, { quoted: mek })
					if (!isGroup)return reply(mess.only.group)
					if (!isGroupAdmins)return reply(mess.only.admin)
           ...
           case 'playmp3':
               ...
               if (anu.error) return reply(anu.error)
                 infomp3 = `「 *TIMELINE PLAY MP3* 」\n*• Título:* ${anu.result.title}\n*• Link:* ${anu.result.source}\n*• Tamaño:* ${anu.result.size}\n\n*ESPERE NUEVAMENTE ENVIANDO POR FAVOR, NO SPAME EL CHAT CSM🖐*`
                ...
                break 
            case 'smule':
					if (args.length < 1) return reply('Codigo url mano?')
					if (!isUrl(args[0]) && !args[0].includes('c-ash.smule')) return reply(mess.error.Iv)
					reply(mess.wait)
					anu = await fetchJson(`https://mnazria.herokuapp.com/api/smule?link=${args[0]}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					teks = `*Título* : ${anu.title}\n\n Espere 1 minuto, talvez un poco mas por que el videodownloader se esta ejecutando`
					thumb = await getBuffer(anu.thumb)
					client.sendMessage(from, thumb, image, {quoted: mek, caption: teks})
					buffer = await getBuffer(anu.result)
					...
					break  
				case 'ttp':
					if (args.length < 1) return reply(' texto, hum?')
					ranp = getRandom('.png')
					rano = getRandom('.webp')
                  ...
                  case 'desbloquear':
				    ...
				    break
                case 'image':
					if (args.length < 1) return reply('que imagen deseas, prro?')
					goo = body.slice(7)
...
break
case 'pasen sexo':
tujuh = fs.readFileSync('./assets/pasensexo.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'pato':
...
break
		   ...
		   await limitAdd(sender)
				...
				case 'addfoto':
					if (!isGroup) return reply(mess.only.group)
					if (!isOwner) return reply('Usted es el dueño? ')
			...
			case 'instaimg':
				...
				break
                                case 'afk':
                                        tels = body.slice(4)
                                        if (args.length < 1) return reply('irme afk a causa de que?')                                  
                                        var nom = mek.participant
                                        const tag = {
                                                text: `@${nom.split("@s.whatsapp.net")[0]} *MÉDIO AFK ${tels} No moleste CSM🖐`,
...
break
		        ...
		        case 'gay':		
					...
					client.sendMessage(from, 'Como usted es gay: *'+rate+'*\n\nSu porcentaje gay : '+ kl+'%', text, { quoted: mek })
					break
                  case 'timer':
				...
				case 'delete':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('marque un mensaje para eliminar *ser administrador!*')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = 'Comando recibido, excluir mensaje :\n'
						...
						mentions(`espera que termine : @${mentioned[0].split('@')[0]}`, mentioned, true)
						client.deleteMessage(from, mentioned)
					}
					break
				case 'openanime':
					...
					if (Number(args[0]) === 1) {
						...
						reply('Activado com sucesso el modo anime en este grupo ✔️')
					} else if (Number(args[0]) === 0) {
						anime.splice(from, 1)
						fs.writeFileSync('./src/anime.json', JSON.stringify(anime))
						reply('Modo anime desactivado com sucesso en este grupo ✔️')
					} else {
				...
				case 'setfoto':
                    ...
                    reply('Altero con exito el icono del grupo')
                    break			
                case 'level':
                ...
                case 'leveling':
					...
					if (args[0] === 'on') {
                    if (isLevelingOn) return reply('*el comando leveling esta activo*')
				...
				break 
					...
					if (Number(args[0]) === 1) {
						...
						reply('Grupo anti-link activado com sucesso en este grupo ✔️')
						client.sendMessage(from,`Atencion a todos los miembros activos de este grupo anti-link. si usted envia un link de grupo(WhatsApp), usted sera expulsado de este grupo`, text)
					} else if (Number(args[0]) === 0) {
						if (!isantilink) return reply('el modo de grupo anti-link fue deshabilitado ')
						var ini = anti.clientOf(from)
						antilink.splice(ini, 1)
						fs.writeFileSync('./src/antilink.json', JSON.stringify(antilink))
						reply('Desactivar grupo anti-link com sucesso en este grupo ✔️')
					} else {
						reply('1 para activar, 0 para desactivar ')
					}
					break
				...
				case 'setnomebot':
					...
					if (!isOwner) return reply(mess.only.ownerB)
					name = body.slice(12)
					reply(`el nombre del bot fue alterado con exito : ${name}`)
					break
					case 'clove':
					  if (args.length < 1) return reply('falta el texto papu?')
                     if (args.length > 10) return reply('por lo menos 10 caracteres')
					 love = `${body.slice(7)}`
			    ...
			    case 'lovemake':
                	...
                	case 'tomp3':
                	client.updatePresence(from, Presence.composing) 
					if (!isQuotedVideo) return reply('Marque el video')
					reply(mess.wait)
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						fs.unlinkSync(media)
						if (err) return reply('❌ Fallo en convertir el vídeo para mp3 ❌')
			    ...
			    case 'waifu':
				    try {
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'sjsjjs hmm'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
				...
				case 'wibu':
                   ...
                   break
					...
					break
				case 'desligar':
				if (!isOwner) return reply('Comando solo para mi dueño ')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
						const media = await client.downloadAndSaveMediaMessage(encmedia)
						client.sendMessage(from, 'BOT DESLIGADO CON SUCESSO', text, { quoted: mek })
						ran = getRandom('.webp')
						await ffmpeg(`./${media}`)
							.input(media)
...
// recursos anime, random @✞︎𝙼𝚎𝚕𝚒𝚘𝚍𝚊𝚜✞︎ domina vida
              ...
              case 'cerpen':
               ...
               case 'puisiimg':
				...
				case 'setppbot':
				client.updatePresence(from, Presence.composing) 
				if (!isQuotedImage) return reply(`Envie fotos con letras ${prefix}setbotpp las tags de imagem ya fueron enviadas`)
					if (!isOwner) return reply(mess.only.ownerB)
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                 infomp3 = `*MUSICA ENCONTRADA!!!*\nTítulo : ${anu.result.title}\nUrl : ${anu.result.source}\nTamanho : ${anu.result.size}\n\n*ESPERE UN POCO NO SPAMEE EL CHAT CSM🖐*`
                buffer = await getBuffer(anu.result.thumbnail)
                lagu = await getBuffer(anu.result.url_audio)
                client.sendMessage(from, buffer, image, {quoted: mek, caption: infomp3})
                client.sendMessage(from, lagu, audio, {mimetype: 'audio/mp4', filename: `${anu.title}.mp3`, quoted: mek})
				...
				case 'setnombre':
                   ...
                   client.sendMessage(from, 'Sucess, altero el nombre del grupo', text, {quoted: mek})
                   break
				case 'galaxtext':
					if (args.length < 1) return reply('o que você quer tio')
					teks = body.slice(12)
          ...
          reply('Espere..')
				...
				case 's':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('error', function (err) {
								...
								fs.unlinkSync(media)
								tipe = media.endsWith('.mp4') ? 'video' : 'gif'
								reply(`❌ Fallo, no se pudo convertir ${tipe} para sticker`)
							})
							.on('end', function () {
								console.log('Finish')
								client.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: mek})
					...
					/*} else if ((isMedia || isQuotedImage) && colors.includes(args[0])) {
						...
						reply(`Envie fotos con las letras: **sticker* o remarque una imagen que ya fue enviada`)
					}
					break
				case 'tts':
					if (args.length < 1) return client.sendMessage(from, 'mm, falto el codigo del lenguaje prro? \n Exemplo: *tts es todos jotos aqui', text, {quoted: mek})
					const gtts = require('./lib/gtts')(args[0])
					if (args.length < 2) return client.sendMessage(from, 'falto el texto', text, {quoted: mek})
					dtt = body.slice(9)
					ranm = getRandom('.mp3')
					rano = getRandom('.ogg')
					dtt.length > 100
					? reply('la mayor parte del texto es kk')
					: gtts.save(ranm, dtt, function() {
						exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
							fs.unlinkSync(ranm)
							buff = fs.readFileSync(rano)
							if (err) return reply('ladraaa:(')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('usted no es un miembro premium, contacte con Hatori o digite *.Daftarvip* para adquirir el acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT ⚡HH BOT⚡ ✨* 」\n*│+ wa.me/`51928564603*╰──────*「 *Hatori Hanzo* 」*────*\n\n*_SE QUER SER ADMIN DO BOT ✞︎𝙼𝚎𝚕𝚒𝚘𝚍𝚊𝚜✞︎_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'loli1':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'hmm, entonces quieres ver una loli?'})
					break
				case 'hentai':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/8U9GwX4.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'mmm, golos@ csm  😂'})
					break
				case 'buendia':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/7VL9cFf.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Buen dia para todos ❤️'})
					break
				case 'buenastardes':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/JaO3yoV.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Buenas tardes con todos los cabros😎👍'})
					break
				case 'buenasnoches':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.imgur.com/yOFxSUR.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Buenas noches, haganse la paja y a mimir csm ❤️'})
					break
                case 'belle':                 
				...
				case 'buenasnoches':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'buenas noches❤️'})
					break
				case 'buendia':
					memein = await kagApi.memeindo()
				...
				case 'dueño':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*𝙲READOR DE ⚡HH BOT⚡, Hatori Hanzo \n*WPP:* wa.me/+51928564603\n\n\nEspero que te guste el bot 💪\n*si no tmb me vale xd*️'})
					break
				...
				case 'setprefix':
					...
					if (!isOwner) return reply(mess.only.ownerB)
					prefix = args[0]
					reply(`el prefijo fue alterado con exito para : ${prefix}`)
					break
				case 'loli':
					loli.getSFWLoli(async (err, res) => {
						if (err) return reply('❌ *ERROR* ❌')
						buffer = await getBuffer(res.url)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'su loli 7u7'})
					})
					break
                case 'lolih':
                    gatauda = body.slice(6)
                    ...
                    break
				case 'nsfwloli':
					if (!isNsfw) return reply('*COMANDO SOLO FUNCIONA EN EL PV AMIGO*')
				...
				case 'yt2mp3':
					...
					break
				case 'tiktok':
					if (args.length < 1) return reply('falta el link prro')
				...
				case 'tiktokstalk':
					try {
						if (args.length < 1) return client.sendMessage(from, 'falta el nombre?', text, {quoted: mek})
						...
						console.log(`Error :`, color(e,'red'))
						reply('Possíble nombre de usuário inválido')
					}
					break
				case 'nulis':
				case 'tulis':
				  client.updatePresence(from, Presence.composing)
			if (args.length < 1) return reply(`que desea escribir?`)
			reply(mess.wait)
					tulis = body.slice(7)
				  nama = tulis.split("/")[0];
					kelas = tulis.split("/")[1];
				...
				case 'tstiker':
				case 'tsticker':
					if (args.length < 1) return reply('Onde está el texto, hum?')
					ranp = getRandom('.png')
					rano = getRandom('.webp')
                ...
                case 'marcar2':
                 ...
                 case 'marcar3':
					...
					break
				case 'limpar':
					if (!isOwner) return reply('quien es usted? usted no es mi dueño 😂')
					anu = await client.chats.all()
					client.setMaxListeners(25)
					for (let _ of anu) {
						client.clearChat(_.jid)
					}
					reply('Excluido todos los chats com exito :)')
					break
				case 'bc':
					if (!isOwner) return reply('quien es usted? usted no es mi dueño 😂')
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `[ TRANSMISION DE AVISO ]\n\n${body.slice(4)}`})
						}
						reply('Transmision enviada con exito')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `[ REPASA EL AVISO ]\n\n${body.slice(4)}`)
						}
						reply('Transmision enviada con exito')
					}
					break
        case 'promover':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Ok, este de aqui: @${mentioned[0].split('@')[0]} ahora es admin del grupo!`, mentioned, true)
				...
				case 'rebajar':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Ok, prro: @${mentioned[0].split('@')[0]} perdio su admin con exito!`, mentioned, true)
				...
				case 'añadir':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('Ud quiere añadir un joto?')
					if (args[0].startsWith('08')) return reply('Use el código de país, man \n ex: +51 928564603')
					try {
						num = `${args[0].replace(/ /g, '')}@s.whatsapp.net`
						client.groupAdd(from, [num])
					} catch (e) {
						console.log('Error :', e)
						reply('Fallo al añadir el destinatario, talvez porque es privado')
					}
					break
				case 'banear':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('marca alguien que desseas eliminar!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = 'Ese ya fue xd :\n'
						for (let _ of mentioned) {
						...
						mentions(`removido con exito  : @${mentioned[0].split('@')[0]}`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'admins':
					...
					break
                                ...
                                case 'sair':
                                        ...
                                        break
				case 'toimg':
					if (!isQuotedSticker) return reply('{ ❗ } *Marque un sticker*')
					reply(mess.wait)
					encmedia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					media = await client.downloadAndSaveMediaMessage(encmedia)
					ran = getRandom('.png')
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						fs.unlinkSync(media)
						if (err) return reply('❌ Fallo al convertir stiker a imagen❌')
						buffer = fs.readFileSync(ran)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: '>//<'})
						fs.unlinkSync(ran)
					})
					break
				case 'simi':
					if (args.length < 1) return reply('falta el texto, hum?')
					teks = body.slice(5)
				...
				case 'simih':
					...
					if (Number(args[0]) === 1) {
						...
						reply('Activado com sucesso o modo simi en este grupo 😗️')
					} else if (Number(args[0]) === 0) {
						samih.splice(from, 1)
						fs.writeFileSync('./src/simi.json', JSON.stringify(samih))
						reply('Desactivado modo simi com sucesso neste grupo 😡️')
					} else {
				...
				case 'bienvenido':
					...
					if (args.length < 1) return reply('Hmmmm')
					if (Number(args[0]) === 1) {
						if (isWelkom) return reply('yá esta activo.')
						welkom.push(from)
						fs.writeFileSync('./src/welkom.json', JSON.stringify(welkom))
						reply('Activo con exito los recurso de bienvenid@s en este grupo 😉️')
					} else if (Number(args[0]) === 0) {
						welkom.splice(from, 1)
						fs.writeFileSync('./src/welkom.json', JSON.stringify(welkom))
						reply('Desactivo con exito los recursos de bienvenid@s en este grupo 😡️')
					} else {
						reply('1 para activar, 0 para desactivar, entendio prro?')
					}
                                      break
				case 'clonar':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (args.length < 1) return reply('Marque las personas que usted quiere clonar\n\n*EjEMPLO:* clone @')
					...
					try {
						...
						mentions(`Foto do perfil actualizada con exito, usando una foto de perfil @${id.split('@')[0]}`, [jid], true)
					} catch (e) {
						reply('Putz, dio error, la persona debe estar sin foto 😔')
					}
					break
		        case 'setfoto2':
                    if (!isGroup) return reply(mess.only.group)
                    ...
                    media = await client.downloadAndSaveMediaMessage(mek)
                    await client.updateProfilePicture (from, media)
                    reply('Alterado con exito el ícono de Grupo')
                    break
                case 'bc2':
					if (!isadminbot) return reply('Quien es usted?')
					if (args.length < 1) return reply('.......')
